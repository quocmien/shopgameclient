                ...
                <div class="row">
                    ...
                    <aside class="col-lg-3 order-lg-first" sticky-container>
                        <div v-sticky="!isSidebar" sticky-offset="{ top: 69 }">
                            ...
                            <shop-sidebar-one :categories="categories" :is-sidebar="isSidebar"></shop-sidebar-one>
                        </div>
                    </aside>
                </div>
            </div>
...
export default {
    ...
    methods: {
        getProducts: async function(samePage = false) {
            ...
            // await Repository.get(`${baseUrl}/products`)
			// 	.then(response => {
        ...
        getCategories: async function() {
			this.loaded = false;
			await Repository.get(`${baseUrl}/product-categories`)
				.then(response => {
